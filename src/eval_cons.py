...
if __name__ == "__main__":
    ...
    for lang in LANGUAGES:
        data = pd.read_csv(f"/datadrive/ayush/home/X_FaKT/results/{dataset}/{args.model}/{prompt}/{lang}.csv")
        data1 = pd.read_csv(f"/datadrive/ayush/home/X_FaKT/results/{dataset}/{args.model}/{prompt}/English.csv")
        results = {}
        count = {}
...
print(f"Mean1 assoc: {mean1}")
print(f"var1 assoc: {var1}")
print(f"Mean2 assoc: {mean2}")
print(f"var2 assoc: {var2}")
